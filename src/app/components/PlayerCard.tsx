...
export default function PlayerCard({player, loggedIn=false, onAddPoints}: PlayerCardProps) {
    return (
        ...
        <div className={`text-center rounded-lg m-3 p-4 flex flex-col items-center flex-shrink-0 w-40 ${player.rank === 1 ? 'text-yellow-100 bg-gradient-to-tl from-yellow-400 to-yellow-600 shadow-2xl shadow-inner' : 'text-white bg-blue-400'}`}>
